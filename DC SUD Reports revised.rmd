...
# Define file locations and column names
```{r}
...
# Playing around with alternatives for the weird loading in practices
```{r}
samp_report <- read_excel(paste(data_dir, sheetlist[1], sep=''), sheet = 'SUD metrics', skip = 9)

comp_samp_report <- read_excel(paste(data_dir, sheetlist[1], sep=''), sheet = 'SUD metrics')
comp_dat <- comp_samp_report[-(c(1:9, 11:13, 88:123)),]
```
